...
export default function Stack({ stack, header, id }) {
  return (
    ...
    >
      <h2 className="text-center text-xl font-medium capitalize text-black dark:text-gray-300 ">
        {header}
      </h2>
          ...
          {stack.map((element) => (
            <div
              ...
              className={`col-span-1 p-1 flex flex-row gap-2 rounded-md ${
                element.important
                  ? "bg-gradient-to-r to-yellow-50 dark:to-black from-yellow-200 dark:from-black dark:border-2 dark:border-yellow-200"
            ...
            >
              ...
              <div className="flex flex-col gap-[2px]">
                ...
                <p className="p-1 text-gray-700 dark:text-gray-400 font-medium capitalize">
                  {element.description}
                </p>
              </div>
            </div>
